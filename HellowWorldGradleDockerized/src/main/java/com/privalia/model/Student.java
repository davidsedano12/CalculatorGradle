...
public class Student {
	...
	public void addStudent() {
		...
		try {
			FileWriter fw = new FileWriter("C:\\Users\\david.sedano\\Documents\\writestudent.txt",true);
			...
			String age = ageRead.readLine();
			student.setAge(student.age.parseInt(age));
			...
			BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\david.sedano\\Documents\\writestudent.txt"));
			String line = null;
